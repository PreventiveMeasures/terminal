...
// `delete array`, `nextfile`, `\y`, regex RS, three-argument match).
// Everything is a real interpreter over an AST — no JS evaluation, and
// no way for a program to reach the host: the forms that would spawn a
// process or write a file (`system()`, `cmd | getline`, `print | cmd`,
// `print > file`) are rejected at parse time with a message saying so.
//
...
// program that does not parse, 2 for a fatal runtime error.
