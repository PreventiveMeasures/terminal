...
// The same line at a glance: the chains it runs, in plain text, or an error
// naming what a summary would have had to leave out.
export const summarize = (line) => summarizeWith(line, true)
